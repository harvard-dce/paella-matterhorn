// #DCE MATT-2429 This override is only for the doShowMessage() height to be minHeight
// in order to properly contain the contents of the message box (i.e. the Flash message)
// Copied from UPV paellaplayer src/01_utils.js
/*
...
Class ("paella.MessageBox", {
	...
	doShowMessage:function(message,closeButton,width,height,className,onClose) {
		...
		messageContainer.className = className;
		messageContainer.style.width = width;
                // #DCE MATT-2429 fix Flash message height
