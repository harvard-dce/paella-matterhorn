...
Class ("paella.PluginManager", {
	...
	eventDrivenPlugins: [],
	enabledPlugins: [],
	// #DCE MATT-2386 halt onresize timer when swapping out master videos
	// https://github.com/polimediaupv/paella/issues/291
	// https://github.com/polimediaupv/paella/pull/292
	doResize: true,
...
//	checkPluginVisibility
	...
	initialize:function() {
		...
		var timer = new base.Timer(function() {
			// #DCE MATT-2386 doResize boolean to halt this timer when swapping out master videos
			// https://github.com/polimediaupv/paella/issues/291
			// https://github.com/polimediaupv/paella/pull/292
